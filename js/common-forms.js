 ...
 * Handles form validation, cascading dropdowns, Google Apps Script submission,
 * and localStorage caching for immediate dashboard reflections.
 */
...
const FLOW_META = {
  ...
  Transfer: {
    ...
    subtitle: 'Move funds between accounts, cash, or e-wallets.',
    save: 'Save Transfer'
  }
};
...
function groupedSourceOptions(items, placeholder) {
  const order = ['🏦 Bank', '💳 Credit', '💵 Cash', '📱 E-Wallet', '🚆 Suica', '👤 Other'];
  const groups = {};
...
// -------------------------------------------------------------
// Local Storage Entry Cache (for instant Dashboard Reflection)
// -------------------------------------------------------------
